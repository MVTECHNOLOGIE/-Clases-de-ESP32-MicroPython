...
pir_pin = machine.Pin(22, machine.Pin.IN)  # Pin digital al que está conectado el sensor PIR
led_pin = machine.Pin(23, machine.Pin.OUT)  # Pin digital al que está conectado el LED
